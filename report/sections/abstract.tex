...
\begin{abstract}
   ...
   \href{https://www.kaggle.com/Cornell-University/arxiv}{Arxiv} and Neural Information Processing 
    ...
    an relational database model that allows the user to do Ad-Hoc queries for analytics. Using \href{https://github.com/deepset-ai/haystack}{haystack}  the application allows for question and answering on user defined abstracts of the database. 
